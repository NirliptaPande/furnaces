# This file will be used for gapfilling the dataset
# We first convert the dataset to a 5D space, (lat,lon, year, month, features)
#then for all features, we gap fill the data with median over a certain month over all the years
import numpy as np
